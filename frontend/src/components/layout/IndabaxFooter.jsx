        ...
        <div className="footer-container">
          ...
          <div className="footer-section footer-brand">
            {settings?.logo_url ? (
              ...
              <h3 className="footer-brand-name">{settings?.site_name || 'Indabax Kabale'}</h3>
            )}
            <p className="footer-tagline">
              {settings?.tagline || 'Advancing AI and Machine Learning in Africa'}
            </p>
            ...
            {(settings?.facebook_url || settings?.twitter_url || settings?.instagram_url || 
              ...
              <div className="footer-social">
                ...
                {settings.twitter_url && (
                  <a href={settings.twitter_url} target="_blank" rel="noopener noreferrer" className="social-link">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                {settings.linkedin_url && (
                  <a href={settings.linkedin_url} target="_blank" rel="noopener noreferrer" className="social-link">
                    <svg viewBox="0 0 24 24" fill="currentColor">
                ...
                {settings.youtube_url && (
                  <a href={settings.youtube_url} target="_blank" rel="noopener noreferrer" className="social-link">
                    <svg viewBox="0 0 24 24" fill="currentColor">
      ...
      <div className="footer-bottom">
        <div className="footer-container">
          <p className="footer-copyright">
            © {currentYear} {settings?.site_name || 'Indabax Kabale'}. All rights reserved.
          </p>
